@extends('layouts.app')
@section('title')
    <a href="{{ url('/armada') }}" class="text-black-600 hover:text-blue-600 hover:none">Master Armada</a> > Ubah Data
@endsection
@section('subtitle', 'Halaman ini digunakan untuk melakukan ubah data armada dalam sistem')
@section('content')

<div class="p-3 md:p-6">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('armada.update', $data->fleet_id) }}" method="POST" class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <select name="transporter_id" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    ...
                    @foreach($transporters as $transporter)
                        <option value="{{ $transporter->transporter_id }}" {{ old('transporter_id', $data->transporter_id) == $transporter->transporter_id ? 'selected' : '' }}>{{ $transporter->transporter_nama }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select name="supir_id" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    ...
                    @foreach($supirs as $supir)
                        <option value="{{ $supir->supir_id }}" {{ old('supir_id', $data->supir_id) == $supir->supir_id ? 'selected' : '' }}>{{ $supir->driver_nama }}</option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select name="jns_fleet_id" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    ...
                    @foreach($jenisFleets as $jenisFleet)
                        <option value="{{ $jenisFleet->jns_fleet_id }}" {{ old('jns_fleet_id', $data->jns_fleet_id) == $jenisFleet->jns_fleet_id ? 'selected' : '' }}>{{ $jenisFleet->jns_fleet_nama }}</option>
                    @endforeach
                </select>
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="fleet_nopol" value="{{ old('fleet_nopol', $data->fleet_nopol) }}" maxlength="10" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                ...
                <div>
                    ...
                    <input type="text" name="fleet_nopin" value="{{ old('fleet_nopin', $data->fleet_nopin) }}" maxlength="10" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="thn_pembuatan" value="{{ old('thn_pembuatan', $data->thn_pembuatan) }}" maxlength="4" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                ...
                <div>
                    ...
                    <input type="text" name="no_stnk" value="{{ old('no_stnk', $data->no_stnk) }}" maxlength="20" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div class="grid md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="date" name="tgl_expired_kir" value="{{ old('tgl_expired_kir', $data->tgl_expired_kir) }}" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                ...
                <div>
                    ...
                    <input type="date" name="tgl_expired_stnk" value="{{ old('tgl_expired_stnk', $data->tgl_expired_stnk) }}" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                ...
                <div>
                    ...
                    <input type="date" name="tgl_expired_pajak" value="{{ old('tgl_expired_pajak', $data->tgl_expired_pajak) }}" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div>
                ...
                <input type="text" name="vendor_gps" value="{{ old('vendor_gps', $data->vendor_gps) }}" maxlength="100" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                @error('vendor_gps')<div class="text-red-500 text-sm mt-1">{{ $message }}</div>@enderror
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                <input type="email" name="emai" value="{{ old('emai', $data->emai) }}" maxlength="100" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="flag_blokir" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                        <option value="1" {{ old('flag_blokir', $data->flag_blokir) == '1' ? 'selected' : '' }}>Ya</option>
                        <option value="2" {{ old('flag_blokir', $data->flag_blokir) == '2' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="fleet_status" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                        <option value="1" {{ old('fleet_status', $data->fleet_status) == '1' ? 'selected' : '' }}>Aktif</option>
                        <option value="2" {{ old('fleet_status', $data->fleet_status) == '2' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
            ...
            <div>
                ...
                <input type="text" name="alasan_blokir" value="{{ old('alasan_blokir', $data->alasan_blokir) }}" maxlength="100" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
