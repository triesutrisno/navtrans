...
@section('title')
    ...
    > Tambah Data
@endsection
@section('subtitle', 'Halaman ini digunakan untuk melakukan tambah data master role kedalam sistem')
@section('content')
...
<div class="p-3 md:p-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ url('/mrole/store') }}" method="POST">
            @csrf
            <!--<div class="grid grid-cols-1 md:grid-cols-2 gap-6">-->
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="role_keterangan" rows="4" class="w-full rounded-md border border-gray-300 focus:ring focus:ring-blue-200">{{ old('role_keterangan') }}</textarea>
                </div>
            <!--</div>-->
            {{-- BUTTON --}}
            <div class="flex justify-end gap-3 mt-8">
                <a href="{{ url('/role') }}" class="px-4 py-2 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition">Kembali</a>
