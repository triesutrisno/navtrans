...
@section('title')
    ...
    > Ubah Data
@endsection
@section('subtitle', 'Halaman ini digunakan untuk melakukan ubah data master transporter kedalam sistem')
@section('content')

<div class="p-3 md:p-6">
    {{-- CARD --}}
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('vendor.update', $data->transporter_id) }}"
              method="POST"
              class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('transporter_nama', $data->transporter_nama) }}"
                       maxlength="100"
            ...
            <div>
                ...
                <input type="text"
                       ...
                       value="{{ old('transporter_pic', $data->transporter_pic) }}"
                       maxlength="100"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div>
                ...
                <input type="text"
                       name="transporter_hp"
                       value="{{ old('transporter_hp', $data->transporter_hp) }}"
                       maxlength="20"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div>
                ...
                <select name="transporter_status" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    <option value="1" {{ old('transporter_status', $data->transporter_status) == '1' ? 'selected' : '' }}>Aktif</option>
                    <option value="2" {{ old('transporter_status', $data->transporter_status) == '2' ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
