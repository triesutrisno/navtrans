...
<div x-data="{ open: false }" class="flex h-screen overflow-hidden">
    ...
    <aside 
        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-3">
            ...
            <!-- MENU -->
            <a href="dashboard" class="block px-3 py-2 rounded hover:bg-red-600">
                Dashboard
            </a>
        ...
        <div class="absolute bottom-0 w-full p-4 bg-red-700 border-t border-width-600 text-sm z-10">
            <div>
            {{ auth()->user()->name }} 
