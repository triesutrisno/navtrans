...
@section('title')
    ...
    > Ubah Data
@endsection
@section('subtitle', 'Halaman ini digunakan untuk melakukan ubah data master provinsi kedalam sistem')
@section('content')

<div class="p-3 md:p-6">
    {{-- CARD --}}
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('propinsi.update', $data->id) }}"
              method="POST"
              class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <input type="text"
                       name="propinsi_kode"
                       value="{{ old('propinsi_kode', $data->propinsi_kode) }}"
                       maxlength="10"
            ...
            <div>
                ...
                <input type="text"
                       name="propinsi_nama"
                       value="{{ old('propinsi_nama', $data->propinsi_nama) }}"
                       maxlength="100"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
