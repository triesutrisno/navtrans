...
@section('title')
    ...
    > Ubah Data
@endsection
@section('subtitle', 'Halaman ini digunakan untuk melakukan ubah data master lokasi kedalam sistem')
@section('content')

<div class="p-3 md:p-6">
    {{-- CARD --}}
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('lokasi.update', $data->id) }}"
              method="POST"
              class="space-y-5">
            @csrf
            ...
            <div>
                ...
                <select name="kecamatan_id" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    ...
                    @foreach($kecamatan as $kec)
                        <option value="{{ $kec->id }}" {{ old('kecamatan_id', $data->kecamatan_id) == $kec->id ? 'selected' : '' }}>
                            {{ $kec->kecamatan_nama }}
                        </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text"
                       name="lokasi_kode"
                       value="{{ old('lokasi_kode', $data->lokasi_kode) }}"
                       maxlength="20"
            ...
            <div>
                ...
                <input type="text"
                       name="lokasi_nama"
                       value="{{ old('lokasi_nama', $data->lokasi_nama) }}"
                       maxlength="100"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                @error('lokasi_nama')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
            ...
            <div>
                ...
                <select name="is_plant" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    ...
                    <option value="1" {{ old('is_plant', $data->is_plant) === '1' ? 'selected' : '' }}>Ya</option>
                    <option value="0" {{ old('is_plant', $data->is_plant) === '0' ? 'selected' : '' }}>Tidak</option>
                </select>
                @error('is_plant')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
                @enderror
            ...
            <div>
                ...
                <select name="is_shipto" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    <option value="">-- Pilih --</option>
                    <option value="1" {{ old('is_shipto', $data->is_shipto) === '1' ? 'selected' : '' }}>Ya</option>
                    <option value="0" {{ old('is_shipto', $data->is_shipto) === '0' ? 'selected' : '' }}>Tidak</option>
                </select>
                @error('is_shipto')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
                @enderror
            ...
            <div>
                ...
                <input type="text"
                       name="latitude1"
                       value="{{ old('latitude1', $data->latitude1) }}"
                       maxlength="50"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                @error('latitude1')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
            ...
            <div>
                ...
                <input type="text"
                       name="longitude1"
                       value="{{ old('longitude1', $data->longitude1) }}"
                       maxlength="50"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                @error('longitude1')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
            ...
            <div>
                ...
                <input type="text"
                       name="radius1"
                       value="{{ old('radius1', $data->radius1) }}"
                       maxlength="50"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                @error('radius1')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
            ...
            <div>
                ...
                <input type="text"
                       name="lokasi_pic"
                       value="{{ old('lokasi_pic', $data->lokasi_pic) }}"
                       maxlength="100"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                @error('lokasi_pic')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
            ...
            <div>
                ...
                <select name="lokasi_status" class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
                    <option value="">-- Pilih --</option>
                    <option value="1" {{ old('lokasi_status', $data->lokasi_status) === '1' ? 'selected' : '' }}>Aktif</option>
                    <option value="0" {{ old('lokasi_status', $data->lokasi_status) === '0' ? 'selected' : '' }}>Tidak Aktif</option>
                </select>
                @error('lokasi_status')
                    <div class="text-red-500 text-sm mt-1"> {{ $message }}</div>
                @enderror
            ...
            <div>
                ...
                <input type="text"
                       name="lokasi_tipe"
                       value="{{ old('lokasi_tipe', $data->lokasi_tipe) }}"
                       maxlength="50"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div>
                ...
                <input type="text"
                       name="lokasi_kontak"
                       value="{{ old('lokasi_kontak', $data->lokasi_kontak) }}"
                       maxlength="50"
                       class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">
            ...
            <div>
                ...
                <textarea name="lokasi_alamat"
                          rows="4"
                          class="w-full rounded-md border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200">{{ old('lokasi_alamat', $data->lokasi_alamat) }}</textarea>
